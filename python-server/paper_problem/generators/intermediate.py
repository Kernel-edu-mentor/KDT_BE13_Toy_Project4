...
class IntermediateProblemGenerator(BaseProblemGenerator):
    """중급 실습 문제 생성"""

    def __init__(self):
        super().__init__(temperature=0.8)  # 더 다양한 문제 생성
...
**필수**: 위 예시는 JSON 구조만 참고하고, 실제 문제 내용은 반드시 제공된 학습 내용에서만 생성할 것!"""
        ...
        return self._create_problems(problems_data, "intermediate")
